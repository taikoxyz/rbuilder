...
use revm_primitives::{ChainAddress, B256};
...
impl BlockBuildingContext {
    ...
    pub fn from_onchain_block(
        ...
        chains.insert(parent_chain_id, ChainBlockBuildingContext::from_onchain_block(onchain_block, chain_spec, spec_id, blocklist, coinbase, suggested_fee_recipient, builder_signer.clone(), root_hasher));
...
impl ChainBlockBuildingContext {
    ...
    pub fn from_attributes(
        ...
        spec_id: Option<SpecId>,
        root_hasher: Arc<dyn RootHasher>,
    ) -> Option<ChainBlockBuildingContext> {
        ...
        Some(ChainBlockBuildingContext {
            block_env,
            initialized_cfg,
            attributes,
            chain_spec,
